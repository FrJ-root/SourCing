...
<body class="bg-black text-white">
    ...
    <div class="hero-section relative">
        <!-- Content -->
        <div class="relative z-10 flex flex-col items-center justify-center h-full text-center px-4 py-32">
            <div class="flex items-center justify-center mb-4">
                <div class="text-blue-500 text-6xl md:text-8xl font-thin">『</div>
                <h1 class="text-4xl md:text-5xl font-bold px-4">Inscription</h1>
                <div class="text-blue-500 text-6xl md:text-8xl font-thin">』</div>
            </div>
            
            <!-- Code in Background -->
            <div class="absolute top-0 left-0 w-full h-full overflow-hidden z-0 opacity-20 flex items-center justify-center">
                <pre class="text-blue-500 text-sm md:text-base font-mono whitespace-pre text-left p-4">
    ...
    <div class="msgSection bg-white text-gray-800 py-16">
        <div class="container mx-auto text-center px-4">
            <h2 class="text-2xl md:text-3xl font-bold uppercase tracking-wider">L'INSCRIPTION REPRENDRA BIENTÔT.</h2>
        </div>
    </div>
